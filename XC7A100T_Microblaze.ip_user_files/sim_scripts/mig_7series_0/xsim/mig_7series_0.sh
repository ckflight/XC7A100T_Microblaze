...
#
# Script generated by Vivado on Wed Aug 06 10:24:20 +0300 2025
...
simulate()
{
  xsim mig_7series_0 -key {Behavioral:sim_1:Functional:mig_7series_0} -tclbatch cmd.tcl -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
