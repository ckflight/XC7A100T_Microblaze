...
#
# Script generated by Vivado on Wed Aug 06 10:34:11 +0300 2025
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/microblaze.protoinst" -log simulate.log
}
