...
#ifndef _microblaze_microblaze_0_xlconcat_0_core_h_
#define _microblaze_microblaze_0_xlconcat_0_core_h_
...
class microblaze_microblaze_0_xlconcat_0_core : public sc_module 
{
    public: 
       microblaze_microblaze_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    ...
    virtual ~microblaze_microblaze_0_xlconcat_0_core() = default;
